              ...
              <div className="p-3 bg-emerald-50/50 rounded-xl border border-emerald-100 flex items-start gap-2.5 text-xs text-emerald-900">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-emerald-800 mt-0.5">
                    Produk ini bersumber asli dari warga / UMKM binaan {settings.bumdesName || 'BUMDes'} {settings.villageName}. Jika barang rusak atau tidak sesuai, dapat ditukar langsung dengan menghubungi penjual atau pengurus desa.
                  </div>
                </div>
              </div>
            </div>
